      ...
      <ul className="grid w-full gap-2 md:grid-cols-4 grid-cols-2 mb-6">
        {selectedNetworks.map((network: NetworkOptions) => (
          <li key={network.network}>
            ...
            />
            <label htmlFor={network.network} className="inline-flex items-center justify-center w-full p-2 text-gray-500 bg-white border-2 border-gray-200 rounded-lg cursor-pointer peer-checked:border-orange-600 hover:text-gray-600 peer-checked:text-gray-600 hover:bg-gray-50 text-center">
              <div className="block">
                <Image src={network.icon} width="50" height="50" alt={network.title} className="mx-auto" />
